...
setMethod("v.switch", sealed = T, signature = c("numeric", "Sim"),
...
setMethod("v.switch", sealed = T, signature = c("numeric"),
...
setMethod("orbit", sealed = T, signature = c("numeric"),
          definition = function(r) {
            with(list(r.n = r[1L], r.a = r[2L], r.b = r[3L]), {
